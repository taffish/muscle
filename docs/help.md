...
Boundaries:
  ...
  tools, downstream phylogenetic tools, PDB/mmCIF download helpers, or
  benchmark data. Generate structure inputs and downstream reports outside this
  app, then pass the prepared files to taf-muscle.
